...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-slate-950/90 backdrop-blur-sm shadow-lg border-b border-slate-800' : 'bg-transparent'}`}>
